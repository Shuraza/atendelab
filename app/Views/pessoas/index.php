            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control" name="nome" required
                        ...
                        pattern="[A-Za-zÀ-ÖØ-öø-ÿ\s']{3,150}"
                        title="Informe apenas letras (mínimo 3 caracteres).">
                </div>
                <div class="col-md-3">
                    ...
                    <input class="form-control" name="documento" required
                        ...
                        title="Informe um CPF com 11 dígitos, no formato 000.000.000-00.">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <input class="form-control" name="curso" maxlength="120">
                </div>
                <div class="col-md-3">
                    ...
                    <input class="form-control" name="periodo"
                        maxlength="3"
                        pattern="\d{1,2}º?"
                        placeholder="Ex.: 5 ou 5º"
                        title="Informe o número do período, com ou sem o º (ex.: 5 ou 5º).">
                    <!--
                        Aceita "5" ou "5º" porque os dados de exemplo do banco
                        já vêm com o º (ver assets/sql/atendelab_completo.sql).
                        Se preferir só números, troque o pattern para \d{1,2}.
                    -->
                </div>
                <div class="col-12">
                    <label class="form-label">Observações</label>
                    <textarea class="form-control" name="observacoes" rows="2" maxlength="1000"></textarea>
                </div>
                <div class="col-md-3">
...
<script>
    ...
    AtendeLabApi.aplicarMascara(formPessoa.elements.documento, AtendeLabApi.maskDocumento);
    AtendeLabApi.aplicarMascara(formPessoa.elements.telefone, AtendeLabApi.maskTelefone);
